    ...
    const breadcrumbs = [
        {
            ...
            href: `/admin/libraries/createLibrary`,
        },
    ];
    const handleAddTag = () => {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            <div className="p-3 lg:p-6">
                <div className="mb-6">
                    ...
                    <h1 className="mt-2 text-2xl font-bold">Create New Library</h1>
                    <p className="text-muted-foreground mt-1">Add a new library with YouTube video content</p>
                </div>
