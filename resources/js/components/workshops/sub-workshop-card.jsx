...
import { Calendar, Users, AlertTriangle, CheckCircle2, CheckCircle } from "lucide-react"
...
export function SubWorkshopCard({ subWorkshop }) {
    ...
    if (!subWorkshop.instructor.en) missingInfo.push("instructor")
        ...
        <Card className="overflow-hidden transition-all hover:shadow-md h-full flex flex-col">
            <CardHeader className="pb-2">
                <div className="flex items-start justify-between">
                    <div>
                        <CardTitle className="text-lg">{subWorkshop.name.en}</CardTitle>
